...
import com.example.myapplication.model.AddProdModel;
import com.example.myapplication.viewholder.RelatedProductsHolder;
...
public class ProductDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(id == 1) {
            ...
            productImg.setImageResource(R.drawable.shoes);
        }else if(id == 2) {
            uniqueId=uniqueId.replaceAll("\n"," ");
            productName.setText(intent.getStringExtra("name").replaceAll("\n"," "));
            ...
            productImg.setImageResource(R.drawable.pngwing);
        }else if(id == 3) {
            productName.setText(intent.getStringExtra("name").replaceAll("\n"," "));
